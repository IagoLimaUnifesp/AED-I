/*1911 - beecrowd - Ajude Girafales*/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>

/*O struct abaixo armazena o nome e a assinatura real de cada aluno*/
typedef struct al{
  char nome[21]; 
  char assinatura[21];
}aluno;
...
/*A função compara recebe os parâmetros Aluno_presente e fassinatura a fim de localizar o aluno na lista e
* comparar a assinatura da lista de presença com a real do aluno, caso seja diferente é retornado 1, caso contrário, retorna-se 0*/
