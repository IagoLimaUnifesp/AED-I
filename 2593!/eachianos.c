/*2593 - beecrowd - Eachianos I (5% Wrong answer)*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>

/*A função recebe os parâmetros palavra e texto que serão comparados para definir as posições
e imprimí-las a cada incidência das palavras no texto */
