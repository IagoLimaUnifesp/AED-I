/*1217 - beecrowd - Getline Two - Frutas*/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
/*Laço para realizar os n casos de testes*/
  for(i = 0; i < n; i++){
    scanf("%lf", &v);
    getchar();
    soma += v;
    ...
    /*A string frutas é dividida com a função strtok e paralelamente é contado o número dessas*/
