/*3149 beecrowd - A Noiva do Trevo*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
/*A função recebe as horas convertidas em minutos e o nome da pessoa e insere ordenadamente de acordo com o horário de avistamento da noiva*/
...
/*Recebimento das entradas e conversão do horário para minutos*/
    scanf("%d:%d", &hora, &min);
    if(min > 59)return 0;
    scanf("%s", nome);
...
/*Inserido somente se a diferença do tempo de avistamento for menor ou igual a p*/
